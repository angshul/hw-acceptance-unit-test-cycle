Feature: search for movies by director
 ...
 Scenario: can't find similar movies if we don't know director (sad path)
  ...
  When  I follow "Find movies with the same Director"
  Then  I should be on the home page
  And I should see "'Alien' has no information about the director" 
  Scenario: add movie
  Given I am on the RottenPotatoes home page
  And  I follow "Add new movie"
  Then I should be on the new movie page
  When I fill in "Title" with "The Incredibles"
  And I select "PG" from "Rating"
  And I press "Save Changes"
  Then I should be on the RottenPotatoes home page
  And I should see "The Incredibles was successfully created."
  Scenario: sort movies alphabetically
  Given I am on the RottenPotatoes home page
  When I follow "Movie Title"
  Then I should see "Aladdin" before "Alien"
